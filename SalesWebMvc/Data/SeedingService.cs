...
{
    public class SeedingService // Quando for criado um SeedingService, automaticamente ele vai receber uma instância do context também
    {
        ...
        public void Seed()
        {
            if (_context.Department.Any() || // A operação "Any" do "Linq" testa se existe algum registro nas tabelas
                _context.Seller.Any() ||
                _context.SalesRecord.Any())
            {
                return; // Se condições acima for True cortará a execução do método. BD já foi populado.
            }
            ...
            // Department d5 = new Department{Id = 5, Name = "Agnaldo"}; // Alternativo
            ...
            _context.Department.AddRange(d1, d2, d3, d4); // "AddRange" = método que adiciona ao BD vários objetos
            ...
            _context.SaveChanges(); // Para salvar e confirmar as alterações no BD
        }
    }
}
